...
library Incense {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "cyberwish", name: "Incense", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626379626572776973680000000000496e63656e7365000000000000000000);

  FieldLayout constant _fieldLayout =
    FieldLayout.wrap(0x00a1060120202020200100000000000000000000000000000000000000000000);
  ...
  // Hex-encoded value schema of (uint256, uint256, uint256, uint256, uint256, bool, string)
  Schema constant _valueSchema = Schema.wrap(0x00a106011f1f1f1f1f60c5000000000000000000000000000000000000000000);
  ...
  function getFieldNames() internal pure returns (string[] memory fieldNames) {
    ...
    fieldNames[2] = "pointsMin";
    fieldNames[3] = "pointsMax";
    fieldNames[4] = "starProbability";
    fieldNames[5] = "easterEggProbability";
    fieldNames[6] = "name";
  }
   ...
   * @notice Get duration.
   */
  function getDuration(bytes32 poolId, uint256 id) internal view returns (uint256 duration) {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = poolId;
    _keyTuple[1] = bytes32(uint256(id));
   ...
   * @notice Get duration.
   */
  function _getDuration(bytes32 poolId, uint256 id) internal view returns (uint256 duration) {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = poolId;
    _keyTuple[1] = bytes32(uint256(id));
   ...
   * @notice Set duration.
   */
  function setDuration(bytes32 poolId, uint256 id, uint256 duration) internal {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = poolId;
    _keyTuple[1] = bytes32(uint256(id));
   ...
   * @notice Set duration.
   */
  function _setDuration(bytes32 poolId, uint256 id, uint256 duration) internal {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = poolId;
    _keyTuple[1] = bytes32(uint256(id));
  ...
  function setPointsMin(bytes32 poolId, uint256 id, uint256 pointsMin) internal {
    ...
    StoreSwitch.setStaticField(_tableId, _keyTuple, 2, abi.encodePacked((pointsMin)), _fieldLayout);
  }
  ...
  function _setPointsMin(bytes32 poolId, uint256 id, uint256 pointsMin) internal {
    ...
    StoreCore.setStaticField(_tableId, _keyTuple, 2, abi.encodePacked((pointsMin)), _fieldLayout);
  }
  ...
  function setPointsMax(bytes32 poolId, uint256 id, uint256 pointsMax) internal {
    ...
    StoreSwitch.setStaticField(_tableId, _keyTuple, 3, abi.encodePacked((pointsMax)), _fieldLayout);
  }
  ...
  function _setPointsMax(bytes32 poolId, uint256 id, uint256 pointsMax) internal {
    ...
    StoreCore.setStaticField(_tableId, _keyTuple, 3, abi.encodePacked((pointsMax)), _fieldLayout);
  }
  ...
  function setStarProbability(bytes32 poolId, uint256 id, uint256 starProbability) internal {
    ...
    StoreSwitch.setStaticField(_tableId, _keyTuple, 4, abi.encodePacked((starProbability)), _fieldLayout);
  }
  ...
  function _setStarProbability(bytes32 poolId, uint256 id, uint256 starProbability) internal {
    ...
    StoreCore.setStaticField(_tableId, _keyTuple, 4, abi.encodePacked((starProbability)), _fieldLayout);
  }
  ...
  function setEasterEggProbability(bytes32 poolId, uint256 id, bool easterEggProbability) internal {
    ...
    StoreSwitch.setStaticField(_tableId, _keyTuple, 5, abi.encodePacked((easterEggProbability)), _fieldLayout);
  }
  ...
  function _setEasterEggProbability(bytes32 poolId, uint256 id, bool easterEggProbability) internal {
    ...
    StoreCore.setStaticField(_tableId, _keyTuple, 5, abi.encodePacked((easterEggProbability)), _fieldLayout);
  }
   ...
   */
  function get(bytes32 poolId, uint256 id) internal view returns (IncenseData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = poolId;
    _keyTuple[1] = bytes32(uint256(id));
   ...
   * @notice Get the full data.
   */
  function _get(bytes32 poolId, uint256 id) internal view returns (IncenseData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = poolId;
    _keyTuple[1] = bytes32(uint256(id));
   ...
   */
  function set(bytes32 poolId, uint256 id, IncenseData memory _table) internal {
    bytes memory _staticData = encodeStatic(
      _table.amount,
      _table.duration,
      _table.pointsMin,
   ...
   * @notice Set the full data using the data struct.
   */
  function _set(bytes32 poolId, uint256 id, IncenseData memory _table) internal {
    bytes memory _staticData = encodeStatic(
      _table.amount,
      _table.duration,
      _table.pointsMin,
    ...
    )
  {
    ...
    duration = (uint256(Bytes.getBytes32(_blob, 32)));

    pointsMin = (uint256(Bytes.getBytes32(_blob, 64)));

    pointsMax = (uint256(Bytes.getBytes32(_blob, 96)));

    starProbability = (uint256(Bytes.getBytes32(_blob, 128)));

    easterEggProbability = (_toBool(uint8(Bytes.getBytes1(_blob, 160))));
  }
  ...
  ) internal pure returns (IncenseData memory _table) {
    (
      _table.amount,
      _table.duration,
      _table.pointsMin,
  ...
  function encodeStatic(
    ...
    return abi.encodePacked(amount, duration, pointsMin, pointsMax, starProbability, easterEggProbability);
  }
