...
export default defineWorld({
  ...
  tables: {
    ...
    Wishes: { schema: { poolId: "bytes32", id: "bytes32", wisher: "address", cycle: "uint256", wishTime: "uint256", incenseExpireTime: "uint256", incenseId: "uint256", blindBoxId: "uint256", pointsIncense: "uint256", pointsBlindBox: "uint256", pointsIncenseEasterEgg: "uint256", pointsBlindBoxEasterEgg: "uint256", propId: "uint256", isStar: "bool", wishContent: "string" }, key: ["poolId", "id"], type: "offchainTable" },
    ...
    IndexToWisher: { schema: { poolId: "bytes32", boostType: "uint256", id: "uint256", index: "uint256", wisher: "address", points: "uint256", wishCount: "uint256", freeWishTime: "uint256" }, key: ["poolId", "boostType", "id", "index"] },
