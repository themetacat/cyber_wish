...
export default defineWorld({
  ...
  tables: {
    ...
    Wishes: { schema: { poolId: "bytes32", id: "bytes32", wisher: "address", wishTime: "uint256", cycle: "uint256", incenseId: "uint256", blindBoxId: "uint256", pointsIncense: "uint256", pointsBlindBox: "uint256", wishContent: "string" }, key: ["poolId", "id"], type: "offchainTable" },
